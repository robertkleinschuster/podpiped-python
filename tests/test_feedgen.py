...
def test_should_generate_valid_rss_podcast():
    ...
    assert channel.find('itunes:image', namespaces).attrib['href'] == 'https://example.com/podcast.jpg'
    ...
    assert episode2.find('enclosure').attrib['url'] == 'https://example.com/episode2.mp3'
    ...
    assert episode1.find('enclosure').attrib['url'] == 'https://example.com/episode1.mp3'
